...
<h1 align="center">📊 Alpha Quant Academy</h1>
...
### 🟡 Track 2: Data Analysis & Manipulation
...
### 🛡️ Track 7: Career & Quant Strategy
...
|-------|---------|----------------|
| 🟢 Beginner | [Stock Portfolio Tracker](projects/beginner/stock_portfolio_tracker/) | Pandas, Matplotlib, Numpy |
| 🟡 Intermediate | [Financial Dashboard](projects/intermediate/financial_dashboard/) | Streamlit, Plotly, APIs |
| 🔴 Advanced | [AI Stock Analyst v2.0](projects/advanced/ai_stock_analyst/) | Quant AI, Multi-agent, Risk |
...
```
alpha-quant-academy/
├── 📁 curriculum/              # Learning modules (01-05)
├── 📁 projects/                # Hands-on projects
│   ├── beginner/               # Stock Tracker
│   ├── intermediate/           # Financial Dashboard
│   └── advanced/               # AI Stock Analyst v2.0
├── 📁 exercises/               # Practice problems
├── 📁 data/                    # Sample datasets (CSV)
├── 📁 webapp/                  # React + Vite Interactive UI
├── 📁 assets/                  # Logos & visuals
├── 📁 docs/                    # Status reports & summaries
...
- 📓 Submit new notebooks or exercises
